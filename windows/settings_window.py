...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/settings/save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("icons/settings/back.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_2.setPlaceholderText(_translate("Form", "Введите IP-адрес сервера"))
        self.lineEdit_3.setPlaceholderText(_translate("Form", "Порт"))
        self.pushButton_6.setText(_translate("Form", "Сохранить и выйти"))
        self.pushButton_7.setText(_translate("Form", "Назад"))
        self.lineEdit_4.setPlaceholderText(_translate("Form", "Введите желаемый ник"))
